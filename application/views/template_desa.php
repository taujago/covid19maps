...
<ul class="nav">
	...
	<li class="nav-item">
		<a class="nav-link" href="<?php echo site_url('AdminDesa'); ?>">
	...
	<li class="nav-item with-sub">
		...
		<li><a class=" <?php echo ($class=="Poktan")?"active":""; ?>" href="<?php echo site_url("Poktan"); ?>">POKTAN</a></li>		
		<li><a class=" <?php echo ($class=="desa")?"active":""; ?>" href="<?php echo site_url("DesaPetani"); ?>">PETANI</a></li>
		<li><a class="" href="<?php echo site_url('Datafisik') ?>">SARANA DAN PRASARANA</a></li>
		<li><a class="" href="<?php echo site_url('DesaTanamPanen') ?>">LUAS TANAM DAN PANEN</a></li>
		<!-- <li><a class="" href="<?php echo site_url('DesaLuasPanen') ?>">LUAS PANEN</a></li> -->
		<li><a class="" href="<?php echo site_url('DesaTargetIndikatif') ?>">TARGET INDIKATIF</a></li>
	...
	<li class="nav-item with-sub">
		<a class="nav-link" href="#">
			...
			<span>LAPORAN DAN  GRAFIK</span>
		</a>
		<div class="sub-item">
			<ul>
				
				<li><a class=" <?php echo ($class=="desa")?"active":""; ?>" href="<?php echo site_url("LapDesaPetani"); ?>">PETANI</a></li>
		<li><a class="" href="<?php echo site_url("LapDesaSarana") ?>">SARANA</a></li>
		<li><a class="" href="<?php echo site_url("LapDesaPrasarana") ?>">PRA-SARANA</a></li>
		<li><a class="" href="<?php echo site_url("LapDesaLuasTanam") ?>">LUAS TANAM</a></li>
		<li><a class="" href="<?php echo site_url("LapDesaLuasPanen") ?>">LUAS PANEN</a></li>
		<li><a class="" href="<?php echo site_url("LapDesaSasaranIndikatif") ?>">SASARAN INDKATIF</a></li>

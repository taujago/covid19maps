...
<div class="col-md-12">
	<div class="card">
		...
		<div class="row">
			...
			$arr_kecamatan = $this->cm->add_arr_head($arr_kecamatan,'','== SEMUA KECAMATAN ==');
		...
		<div class="col-md-4">
			...
			<input type="text" name="nama" id="nama" placeholder="Cari Desa" class="form-control"> 
				...
				<div class="col-md-12">
					...
					<thead  class="bg-primary text-white">
						<tr>
							...
							<th class="text-white " width="30%">Nama Desa</th>
							<th class="text-white " width="30%">Kecamatan</th>

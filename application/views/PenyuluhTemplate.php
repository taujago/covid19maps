			...
			<div class="page-main">
				...
				<header class="app-header header">
					...
					<div class="container-fluid">
						<div class="d-flex">
							<a class="header-brand" href="<?php echo site_url("PenyuluhDashboardView"); ?>">
								...
								<div class="dropdown">
									<a class="nav-link pr-0 leading-none d-flex" data-toggle="dropdown" href="#">
										...
										<span class="ml-2 d-none d-lg-block">
											<span class="text-dark"><?php echo $userdata['nama_penyuluh'] ?></span>
										</span>
									</a>
				...
				<aside class="app-sidebar">
					<div class="app-sidebar__user">
						<div class="dropdown">
							<a class="nav-link p-0 leading-none d-flex" data-toggle="dropdown" href="#">
								...
								<span class="ml-2 "><span class="text-dark app-sidebar__user-name font-weight-semibold"><?php echo $userdata['nama_penyuluh'] ?></span><br>
									<span class="text-muted app-sidebar__user-name text-sm">Penyuluh</span>
								</span>
							</a>
					...
					<ul class="side-menu">
 				 			...
 				 			<li>
							<a class="side-menu__item <?php echo ($class=="penyuluhdashboard")?"active":""; ?>" href="<?php echo base_url("PenyuluhDashboard"); ?>" ><i class="side-menu__icon fa fa-home"></i><span class="side-menu__label">DASHBOARD</span></a>
						</li>


						
						 <li>
							<a class="side-menu__item <?php echo ($class=="penyuluhtani")?"active":""; ?>"  href="<?php echo site_url("PenyuluhTani"); ?>"><i class="side-menu__icon fa fa-user"></i><span class="side-menu__label">DATA PETANI</span></a>
						</li>

						<li>
							<a class="side-menu__item <?php echo ($class=="datafisik")?"active":""; ?>"  href="<?php echo site_url("PDatafisik"); ?>"><i class="side-menu__icon fa fa-cog"></i><span class="side-menu__label">SARANA & PERALATAN</span></a>
						</li>
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								<li><a class="slide-item <?php echo ($class=="grafikpetani")?"active":""; ?>" href="<?php echo site_url('PGrafikPetani') ?>">Petani</a></li>
								<li><a class="slide-item <?php echo ($class=="GrafikDataFisik")?"active":""; ?>" href="<?php echo site_url('PGrafikDataFisik') ?>">Petani & Bangunan Fisik</a></li>
								<li><a class="slide-item <?php echo ($class=="grafikpetani")?"active":""; ?>" href="<?php echo site_url('PGrafikAlsintanPetani') ?>">Petani & Alsintan</a></li>
